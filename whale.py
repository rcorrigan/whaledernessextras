"""
Mask R-CNN
Train on the whale tail dataset and implement color splash effect.

Copyright (c) 2018 Matterport, Inc.
Licensed under the MIT License (see LICENSE for details)
Written by Waleed Abdulla
Updated slightly by Rae Ann Corrigan to fit Happywhale Dataset
Date of updates: 27 April 2019 - 29 April 2019
...
class WhaleDataset(utils.Dataset):
    ...
    def load_whale(self, dataset_dir, subset):
        """Load a subset of the whale tail dataset.
